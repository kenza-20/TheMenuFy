            ...
            <div className="flex flex-col lg:flex-row justify-between">
              <div className="relative flex gap-6 items-start">
                <div className="-mt-20 w-40">
                  <Avatar
                    src="/img/team-5.jpg"
                    alt="Profile picture of Sarra Ben Hamouda"
                    variant="circular"
            ...
            <div className="mb-10 py-6">
              <div className="flex w-full flex-col items-start lg:w-2/3">
                <Typography className="mb-6 font-normal text-blue-gray-500">
                  Passionate about web development, Sarra is an aspiring developer with experience in
                  modern web technologies. She enjoys creating dynamic and interactive web applications.
                </Typography>
