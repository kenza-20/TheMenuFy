                    ...
                    <div className="relative">
                        ...
                        {isProfileOpen && (
                            <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-lg py-2 text-black z-50">
                                ...
                                <Link to="/favorites" className="block px-4 py-2 hover:text-yellow-500" onClick={() => setIsProfileOpen(false)}>Favorites</Link>
            ...
            <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 space-x-8">
                {!authenticated ? (
                    ...
                    <>
                        ...
                        <Link to="/resto/2/dish/nutritional-info" className="text-white hover:text-yellow-500 transition">Tips</Link>
