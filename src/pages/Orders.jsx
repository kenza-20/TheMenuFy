                        ...
                        {orders.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {orders.map(order => (
                                    ...
                                    >
                                        <h3 className="text-xl font-semibold text-yellow-400 mb-2">Order ID: {order.id_order}</h3>
                                        <p className="text-gray-300 text-sm mb-4">Dish ID: {order.id_dish}</p>
                                        <img src={getDishImage(order.id_dish)} alt="Dish" className="w-full h-48 object-cover rounded-lg mb-4" />
