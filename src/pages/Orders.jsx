...
const menuItems = [
  { id: 1, name: 'Salade César', price: 8.90, image: 'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTH3xpcoJVqNygIpxeIdf_DQ2q46z3-cLyHnkXGwlyft5z1bHRQ7OuXRhe0iZ3h063yoNnaJIfLq7T20ZbeOzFNdcU7Pbe4k6di2JFX3LY' },
  { id: 2, name: 'Bœuf Bourguignon', price: 18.50, image: 'https://www.seriouseats.com/thmb/_CovX26D-Z6wpeDYJXGhFhA47H8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/MMPSOUPSANDSTEWS-SEA-BoeufBourguignon-FredHardyII-000-991c38a78f934722954c47567b6be97b.jpg' },
  { id: 3, name: 'Crème Brûlée', price: 6.90, image: 'https://assets.afcdn.com/recipe/20161201/4190_w1024h1024c1cx2705cy1803.webp' },
];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="relative flex-grow flex items-center justify-center py-6 px-4 sm:px-6 lg:px-20">
        <div className="w-full max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-yellow-400 text-center mb-8">My Orders</h1>
