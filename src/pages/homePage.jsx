...
useEffect(() => {
  ...
  <Link
    to="/time-based-meals"
    className="bg-teal-500 text-white px-6 py-3 rounded-full font-medium hover:bg-teal-600 transition duration-300 shadow-md"
  >
  ...
  <Link
    to="/mood"
    className="bg-emerald-500 text-white px-6 py-3 rounded-full font-medium hover:bg-emerald-600 transition duration-300 shadow-md"
  >
    🧠 Meal Suggestions by Mood
  </Link>

  <Link
    to="/voice-menu"
    className="bg-yellow-400 text-black px-6 py-3 rounded-full font-medium hover:bg-yellow-500 transition duration-300 shadow-lg flex items-center gap-2"
  >
    🎤 Menu Vocal IA
  </Link>
</div>
<div className="mt-10 flex justify-center">
  <Link
    to="/voice-panier"
    className="bg-yellow-400 text-black px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-yellow-300 transition transform hover:scale-105"
  >
    🎤 Commander directement par la voix
  </Link>
</div>

{/* 🎮 Adventure Story CTA */}
<div className="w-full mt-10 animate-fade-in text-center">
  <h2 className="text-2xl font-semibold text-white drop-shadow mb-3">
    🎮 Prêt pour une expérience magique ?
  </h2>
  <p className="text-gray-200 mb-4 text-lg">
    Découvre quel plat ton âme choisira à travers une aventure culinaire interactive.
  </p>
  <Link
    to="/interactive-story"
    className="inline-block bg-gradient-to-r from-pink-500 via-red-500 to-yellow-400 hover:brightness-110 text-white font-bold px-8 py-3 rounded-full shadow-xl transition-all duration-300 hover:scale-105"
  >
    ✨ Lancer l’Aventure
  </Link>
</div>
